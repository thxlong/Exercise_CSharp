...
namespace Exercise_CSharp.Actions
{
    public class ActionEx
    {
        ...
        public void DeBai1()
        {
            string debai = "Bài 1: Viết khởi tạo, log ra giá trị \n Viết chương trình xuất ra màn hình các dòng sau: \n 1. Họ và tên \n 2. Năm sinh \n 3. Giới tính \n 4. Tuổi";
        ...
        public void Debai4()
        {
            string debai4 = "Bài 4: Tìm x, y khi biết tổng và hiệu của chúng";
        ...
        public void Debai10()
        {
            string debai10 = "Bài 10: Viết chương trình nhập vào điểm trung bình và kết quả xếp loại của học sinh theo tiêu chuẩn sau: (dùng toán tử 3 ngôi) \n Giỏi: Nếu điểm >= 8; \n Khá: Nếu 8 > điểm >= 6.5; \n Trung bình: Nếu 6.5 > Điểm >= 5; \n Yếu Nếu Điểm < 5";
